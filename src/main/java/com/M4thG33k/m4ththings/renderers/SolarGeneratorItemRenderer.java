 ...
 */
public class SolarGeneratorItemRenderer implements IItemRenderer {

    private TileEntitySpecialRenderer renderer;
    private TileEntity tileEntity;

    public SolarGeneratorItemRenderer(TileEntitySpecialRenderer tesr,TileEntity tileEntity)
    {
        this.renderer = tesr;
